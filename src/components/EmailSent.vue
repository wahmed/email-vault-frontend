    ...
    <div class="sign-in">
      <div style="display: flex; justify-content: center">
        <div class="box">
          ...
          <p class="para">
            Just click on the link in that email to complete password reset
            process.
          </p>
          <hr class="line" />
          <div class="create-account">
            Have't received any email?
            <router-link to="/reset-password" style="text-decoration: none"
...
const email = ref(userStore.getEmail1());
</script>
<style scoped>
.container {
  display: flex;
